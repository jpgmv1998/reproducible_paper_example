...
load("data/raw2clean/muniDivision2015_ibge/output/clean_muniDivision2015.Rdata")



# BRAZILIAN BIOMES DIVISION SHAPEFILE
load("data/raw2clean/biomeDivision_ibge/output/clean_biomeDivision.Rdata")
...
save(spatial.sample.muniLevel,
     file = file.path("data/projectSpecific/muniLevel",
                      "spatial_sample_muniLevel.Rdata"))

save(crossSection.sample.muniLevel,
     file = file.path("data/projectSpecific/muniLevel",
                      "crossSection_sample_muniLevel.Rdata"))

save(panel.sample.muniLevel,
     file = file.path("data/projectSpecific/muniLevel",
                      "panel_sample_muniLevel.Rdata"))
