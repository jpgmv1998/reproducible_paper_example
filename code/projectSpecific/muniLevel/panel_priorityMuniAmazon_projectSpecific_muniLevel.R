...
# START TIME
tictoc::tic(msg = "panel_priorityMuniAmazon_projectSpecific_muniLevel script", log = T)
...
load("data/raw2clean/priorityMuniAmazon_mma/output/clean_priorityMuniAmazon.Rdata")
...
save(panel.priorityMuniAmazon.muniLevel,
     file = file.path("data/projectSpecific/muniLevel",
                      paste0("panel_priorityMuniAmazon_muniLevel", ".Rdata")))
