...
# START TIME
tictoc::tic(msg = "sample_forAnalysis_muniLevel script", log = T)
...
# SPATIAL
load("data/projectSpecific/muniLevel/spatial_sample_muniLevel.Rdata")

# CROSS-SECTION
load("data/projectSpecific/muniLevel/crossSection_sample_muniLevel.Rdata")
...
load("data/projectSpecific/muniLevel/panel_priorityMuniAmazon_muniLevel.Rdata")

# DEFORESTATION
load("data/projectSpecific/muniLevel/panel_prodesDeforestationAmazonMuni_muniLevel.Rdata")
...
save(panel.forAnalysis.muniLevel,
     file = file.path("data/projectSpecific/muniLevel",
                      "panel_forAnalysis_muniLevel.Rdata"))

save(spatial.forAnalysis.muniLevel,
     file = file.path("data/projectSpecific/muniLevel",
                      "spatial_forAnalysis_muniLevel.Rdata"))

save(crossSection.forAnalysis.muniLevel,
     file = file.path("data/projectSpecific/muniLevel",
                      "crossSection_forAnalysis_muniLevel.Rdata"))
