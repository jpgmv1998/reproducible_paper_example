...
# START TIME
tictoc::tic(msg = "biomeDivision_raw2clean script", log = T)
...
# read shapefile
raw.biome <- sf::st_read(dsn   = "data/raw2clean/biomeDivision_ibge/input",
                         layer = "lm_bioma_250")
...
sink("data/raw2clean/biomeDivision_ibge/documentation/codebook_biomeDivision.txt") # create text file to be filled with console output
...
save(clean.biomeDivision,
     file = file.path("data/raw2clean/biomeDivision_ibge/output",
                      "clean_biomeDivision.Rdata"))
