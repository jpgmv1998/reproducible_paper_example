...
# START TIME
tictoc::tic(msg = "priorityMuniAmazon_raw2clean script", log = T)
...
raw.priorityMuniAmazon.1 <- data.frame(tabulizer::extract_tables("data/raw2clean/priorityMuniAmazon_mma/input/lista_municipios_prioritarios_AML_2017.pdf",
                                                                 pages = 1, output = "data.frame", encoding = "UTF-8"))

# extract table from second page of the PDF
raw.priorityMuniAmazon.2 <- data.frame(tabulizer::extract_tables("data/raw2clean/priorityMuniAmazon_mma/input/lista_municipios_prioritarios_AML_2017.pdf",
...
sink("data/raw2clean/priorityMuniAmazon_mma/documentation/codebook_priorityMuniAmazon.txt") # create text file to be filled with console output
...
save(clean.priorityMuniAmazon,
     file = file.path("data/raw2clean/priorityMuniAmazon_mma/output",
                      paste0("clean_priorityMuniAmazon", ".Rdata")))
