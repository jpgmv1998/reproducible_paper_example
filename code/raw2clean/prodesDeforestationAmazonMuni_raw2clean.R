...
# START TIME
tictoc::tic(msg = "prodesDeforestationAmazonMuni_raw2clean script", log = T)
...
aux.txtFiles <- list.files(path = "data/raw2clean/prodesDeforestationAmazonMuni_inpe/input",
                                 pattern = "*.txt",
                                 full.names = T)
...
sink("data/raw2clean/prodesDeforestationAmazonMuni_inpe/documentation/codebook_prodesDeforestationAmazonMuni.txt") # create text file to be filled with console output
...
save(clean.prodesDeforestationAmazonMuni,
     file = file.path("data/raw2clean/prodesDeforestationAmazonMuni_inpe/output",
                      "clean_prodesDeforestationAmazonMuni.Rdata"))
