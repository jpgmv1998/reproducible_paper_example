...
# START TIME
tictoc::tic(msg = "muniDivision2015_raw2clean script", log = T)
...
# read shapefile
raw.muni <- sf::st_read(dsn   = "data/raw2clean/muniDivision2015_ibge/input",
...
sink("data/raw2clean/muniDivision2015_ibge/documentation/codebook_muniDivision2015.txt") # create text file to be filled with console output
...
save(clean.muniDivision2015,
     file = file.path("data/raw2clean/muniDivision2015_ibge/output",
